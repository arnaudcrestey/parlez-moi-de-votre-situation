      ...
      <div className="mx-auto flex min-h-[calc(100vh-3rem)] max-w-6xl flex-col justify-between gap-10 lg:gap-14">
        <section className="grid items-center gap-8 pt-6 lg:grid-cols-[1.1fr_0.9fr] lg:pt-10">
          <div className="animate-reveal space-y-8">
            <div className="inline-flex rounded-full border border-mirror-border bg-[rgba(255,250,244,0.82)] px-4 py-2 text-xs uppercase tracking-[0.16em] text-mirror-copper shadow-soft">
              Éclairage intuitif personnalisé
            </div>
            <div className="space-y-5">
              <h1 className="max-w-3xl text-5xl font-semibold leading-[1.02] text-mirror-ink sm:text-6xl lg:text-[4.75rem]">
                Et si ce que vous ressentez confusément avait déjà quelque chose à vous dire&nbsp;?
              </h1>
              <p className="max-w-2xl text-lg leading-8 text-mirror-muted sm:text-xl">
                Décrivez ce que vous traversez aujourd’hui et recevez un premier éclairage sur ce qui se joue en vous.
              </p>
            </div>
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
              <Link className="mirror-button w-full sm:w-auto" href="/analyse?mode=input">
                Commencer
              </Link>
              <p className="text-sm leading-6 text-mirror-muted">Un parcours simple, calme et structuré pour clarifier ce que vous sentez déjà.</p>
            </div>
          </div>
                ...
                <div className="space-y-5">
                  <div className="rounded-[26px] border border-[rgba(90,60,40,0.1)] bg-[rgba(246,239,231,0.85)] p-6">
                    ...
                    <p className="mt-3 text-2xl font-medium leading-9 text-mirror-brown">
                      Un espace sobre pour déposer votre vécu et faire émerger un premier axe de clarté.
                    </p>
                  </div>
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="rounded-[24px] border border-mirror-border bg-[rgba(255,250,244,0.9)] p-5">
                      <p className="text-sm text-mirror-muted">Un rythme doux</p>
                      <p className="mt-2 text-lg font-medium text-mirror-text">Écriture libre, lecture sensible, restitution structurée.</p>
                    </div>
                    <div className="rounded-[24px] border border-mirror-border bg-[rgba(255,250,244,0.76)] p-5">
                      <p className="text-sm text-mirror-muted">Une esthétique feutrée</p>
                      <p className="mt-2 text-lg font-medium text-mirror-text">Terre, ivoire, cuivre et silence visuel pour mieux respirer.</p>
                    </div>
                  </div>
                </div>
